...
INSERT INTO `dateprice` VALUES (29, '2020-11-20', 1, '￥', 449.00, 1);
INSERT INTO `dateprice` VALUES (30, '2020-11-21', 1, '￥', 449.00, 1);
...
-- Records of owner
-- ----------------------------
INSERT INTO `owner` VALUES (1, 'ceshihao1', '25d55ad283aa400af464', '幽默主义', 1, 'ia_200000106.png');
...
CREATE TABLE `room`  (
  ...
  `img_t` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '房屋首页展示图片',
  `img_c` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '房屋图片(内容展示)url',
...
-- Records of room
-- ----------------------------
INSERT INTO `room` VALUES (1, '【诗和远方】春熙路/盐市口/太古里/天府广场', '锦江区', '30.660947', '104.078819', '整套出租', 6, 3, 5.0, 110, '3室2厅', '1卫1厨2阳台', 'ia_200002494.webp', 'ia_200002498.webp', '房子位于成都市中心的中心,背靠春熙路,毗邻盐市口,左拥太古里,右徬天府广场,出门步行三四十米就可抵达繁华的春熙路步行街了,地理位置极其优越。楼下商场商铺云集,美食酒楼林立,多趟公交车从楼下经过停靠,距地铁天府广场站仅500米左右,机场专线1号线终点站起步价即到,步行10分钟即到小家,无论吃喝玩乐还是衣食住行都极其方便。', '超大的投影墙,网络电视 海量影视随便看 .免费提供一次性牙刷牙膏 .免费提供洗发水、沐浴乳、浴巾 .床品采用舒适的水洗棉,裸睡力MAX .充足的自然光及绿萝植物 .所有床上用品及浴巾一客一换,干净卫生', '机场:打车30分钟左右,约48元。约18.3公里 地铁:10号线到春熙路下,步行300米左右。可以停车，但是需要单独收费。', '四川省成都市锦江区东大街上东大街118号', 120, 429.00, 1);
...
CREATE TABLE `roomimg`  (
  ...
  `roomId` int(11) NOT NULL COMMENT '外键rid',
  `banner` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '图片',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of roomimg
-- ----------------------------
INSERT INTO `roomimg` VALUES (1, 1, '/public/img/house/h1/ia_200002494.webp');
INSERT INTO `roomimg` VALUES (2, 1, '/public/img/house/h1/ia_200002495.webp');
INSERT INTO `roomimg` VALUES (3, 1, '/public/img/house/h1/ia_200002496.webp');
INSERT INTO `roomimg` VALUES (4, 1, '/public/img/house/h1/ia_200002497.webp');
INSERT INTO `roomimg` VALUES (5, 1, '/public/img/house/h1/ia_200002498.webp');
INSERT INTO `roomimg` VALUES (6, 1, '/public/img/house/h1/ia_200002499.webp');
INSERT INTO `roomimg` VALUES (7, 1, '/public/img/house/h1/ia_200002500.webp');
INSERT INTO `roomimg` VALUES (8, 1, '/public/img/house/h1/ia_200002501.webp');
INSERT INTO `roomimg` VALUES (9, 1, '/public/img/house/h1/ia_200002505.webp');
INSERT INTO `roomimg` VALUES (10, 1, '/public/img/house/h1/ia_200002506.webp');
INSERT INTO `roomimg` VALUES (11, 1, '/public/img/house/h1/ia_200002511.webp');
INSERT INTO `roomimg` VALUES (12, 1, '/public/img/house/h1/ia_200002512.webp');
