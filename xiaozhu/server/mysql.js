...
// const sequelize = new Sequelize('solux','root','098765_qw',{
	host:'localhost',
	dialect:'mysql'
})
...
module.exports = { Room,Dateprice,Area,Equipment,RoomImg,Rule,Owner,LandScape,Landscapewithroom,Title}